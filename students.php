                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo    '<div class="row bg-white bar py-2 my-1" id="info">
                                            ...
                                            <div class="col-1 d-flex justify-content-center align-items-center" id="editer">
                                                <a href="edit.php?edit=' . $row["student_id"] . '"><img class="px-2" src="icons/pen.svg" alt=""></a>
                                                <a href="delete.php?delete=' . $row["student_id"] . '"><img class="px-2" src="icons/can.svg" alt=""></a>
                                            </div>
                                        </div>';
                        }
                    } else {
